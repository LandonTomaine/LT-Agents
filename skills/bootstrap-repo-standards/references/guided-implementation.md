...
- implementation, orchestration, docs-audit, docs-update, and UI-validation skills
...
Use `scripts/scaffold_backbone.py <repo> --mode draft --set <set>` for approved draft skeletons. The script requires explicit `--set`; do not rely on defaults.
...
- File-based delivery: `file-backlog`, then `implementation-skills`, `orchestration-skill`, `skills`
- Docs/skills governance: `docs-audit-skills`
